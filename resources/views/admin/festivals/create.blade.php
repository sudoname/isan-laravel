...
@section('title', 'Create New Festival')
@section('page-title', 'Create New Festival')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <form id="festivalForm" action="{{ route('admin.festivals.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="10"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent tinymce">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Main image for the festival (JPEG, JPG, PNG, WEBP, max 5MB)</p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Select multiple images for the gallery (JPEG, JPG, PNG, WEBP, max 5MB each)</p>
            ...
            <div class="flex justify-end space-x-4 pt-6 border-t">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Create Festival
                </button>
            </div>
        </form>
    </div>
    ...
    if (files.length > 0) {
        Array.from(files).forEach((file, index) => {
            ...
            reader.onload = function(e) {
                ...
                div.innerHTML = `
                    <img src="${e.target.result}" alt="Gallery ${index + 1}" class="w-full h-32 object-cover rounded-lg">
