...
@section('page-title', 'Edit Natural Resource')
...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.natural-resources.update', $resource) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number"
                           name="display_order"
                           id="display_order"
                           value="{{ old('display_order', $resource->display_order) }}"
                           min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description"
                              ...
                              rows="3"
                              required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">{{ old('description', $resource->description) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="content"
                              ...
                              rows="10"
                              required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">{{ old('content', $resource->content) }}</textarea>
                    ...
                    @if($resource->image)
                        <div class="mb-4">
                            ...
                            <img src="{{ asset('storage/' . $resource->image) }}"
                                 alt="{{ $resource->name }}"
                                 class="w-48 h-36 object-cover rounded border-2 border-gray-300">
                        </div>
                    @endif
