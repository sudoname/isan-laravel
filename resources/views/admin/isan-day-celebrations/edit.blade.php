...
@section('title', 'Edit Isan Day Celebration')
@section('page-title', 'Edit Isan Day Celebration')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.isan-day-celebrations.update', $isanDayCelebration) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="title"
                               id="title"
                               value="{{ old('title', $isanDayCelebration->title) }}"
                               required
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="slug"
                               id="slug"
                               value="{{ old('slug', $isanDayCelebration->slug) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="date"
                                   ...
                                   id="celebration_date"
                                   value="{{ old('celebration_date', $isanDayCelebration->celebration_date->format('Y-m-d')) }}"
                                   required
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="location"
                                   id="location"
                                   value="{{ old('location', $isanDayCelebration->location) }}"
                        ...
                        <div>
                            ...
                            <select name="status"
                                ...
                                @foreach($statuses as $s)
                                    <option value="{{ $s }}" {{ old('status', $isanDayCelebration->status) == $s ? 'selected' : '' }} class="capitalize">{{ ucfirst($s) }}</option>
                                @endforeach
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="theme"
                               id="theme"
                               value="{{ old('theme', $isanDayCelebration->theme) }}"
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  ...
                                  rows="3"
                                  maxlength="500"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description', $isanDayCelebration->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="full_description"
                                  id="full_description"
                                  rows="10"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent tinymce @error('full_description') border-red-500 @enderror">{{ old('full_description', $isanDayCelebration->full_description) }}</textarea>
                    ...
                    <!-- Current Image -->
                    @if($isanDayCelebration->image_url)
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Current Image</label>
                            <img src="{{ asset('storage/' . $isanDayCelebration->image_url) }}"
                                 alt="{{ $isanDayCelebration->title }}"
                    ...
                    <div>
                        <label for="image_url" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ $isanDayCelebration->image_url ? 'Replace Image' : 'Celebration Image' }}
                        </label>
                        <input type="file"
                               name="image_url"
                               id="image_url"
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="display_order"
                               id="display_order"
                               value="{{ old('display_order', $isanDayCelebration->display_order) }}"
                               min="0"
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <input type="checkbox"
                                   ...
                                   id="is_featured"
                                   value="1"
                                   {{ old('is_featured', $isanDayCelebration->is_featured) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center">
                            <input type="checkbox"
                                   ...
                                   id="is_published"
                                   value="1"
                                   {{ old('is_published', $isanDayCelebration->is_published) ? 'checked' : '' }}
                                   class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Update Celebration
                </button>
            </div>
        </form>
    </div>
