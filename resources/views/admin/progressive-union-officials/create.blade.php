...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.progressive-union-officials.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t mt-6">
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i> Save Official
                </button>
            </div>
        </form>
    </div>
